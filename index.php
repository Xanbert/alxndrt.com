    ...
    <body class="mdui-appbar-with-toolbar mdui-theme-accent-blue">
        <header class="mdui-appbar mdui-appbar-fixed" style="z-index:5000;">
            <div class="mdui-toolbar" >
                ...
                <span id="bar-title">Alxndrt</span>
            ...
            <div id="drawer" class="mdui-drawer mdui-drawer-close">
                <ul class="mdui-list">
                    <li class="mdui-list-item mdui-ripple mdui-list-item-active">
                        <i class="mdui-list-item-icon mdui-icon material-icons mdui-text-color-theme-accent">home</i>
                        <div class="mdui-list-item-content mdui-text-color-theme-accent">主页</div>
                    </li>
        ...
        <div class="mdui-container">
            <div class="mdui-col-md-9 mdui-col-xs-12 card-container">
                <div class="mdui-card mdui-hoverable">
                    <div class="mdui-card-media">
                        <img class="card-img" src="../assest/pic4.jpg">
                    </div>
                    <div class="mdui-card-primary">
                        <div class="mdui-card-primary-title">Blog</div>
                        <div class="mdui-card-primary-subtitle">Alexandrite的无聊日记</div>
                    </div>
                </div>
            </div>
            <div class="mdui-col-md-3 mdui-col-xs-12 card-container">
                <div class="mdui-card mdui-hoverable">
                    <div class="mdui-card-media">
                        <img class="card-img" src="../assest/pic3.jpg">
                    </div>
                    <div class="mdui-card-primary">
                        <div class="mdui-card-primary-title">Git</div>
                        <div class="mdui-card-primary-subtitle">kde美化笔记</div>
                    </div>
                </div>
            </div>
            <div class="mdui-col-md-6 mdui-col-xs-12 card-container">
                <div class="mdui-card mdui-hoverable">
                    <div class="mdui-card-media">
                        <img class="card-img" src="../assest/pic2.png">
                    </div>
                    <div class="mdui-card-primary">
                        <div class="mdui-card-primary-title">Drive</div>
                        <div class="mdui-card-primary-subtitle">个人网盘</div>
                    </div>
                </div>
            </div>
            <div class="mdui-col-md-6 mdui-col-xs-12 card-container">
                <div class="mdui-card mdui-hoverable">
                    ...
                    <div class="mdui-card-primary">
                        <div class="mdui-card-primary-title">Friends</div>
                        <div class="mdui-card-primary-subtitle">Oganesson</div>
                    </div>
                </div>
            </div>
        </div>
